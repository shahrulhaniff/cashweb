...
$tarikh= DateTime::createFromFormat('Y-m-d H:i:s', $tarikh)->format('d/m/Y g:i a');
									...
									<A HREF='../extension/html2pdf/cetakP006_Resit.php?idt=<?=$info['id_transaksi'];?>' target='_blank' class="btn btn-default"><IMG SRC='imgs/print.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='cetak' TITLE='Cetak'>Cetak</A>
