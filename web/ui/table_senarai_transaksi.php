...
<div id='cssmenu'>
	<ul>
		<li class="<? echo ($flag=='tb_1'?'active':'') ?>"><a href="P006.php?dt=tiada&flg=tb_1">Papar Semua</a></li>
		<? if ($dateSelection=='tiada' || $dateSelection==''){
			
			?>
		<li class="<? echo ($flag=='tb_2'?'active':'') ?>"><a href="P006.php?dt=<? echo $current_date; //21-03-2019?>&flg=tb_2">Carian Mengikut Tarikh</a></li>
		<? }else {?>
		<li class="<? echo ($flag=='tb_2'?'active':'') ?>"><a href="P006.php?dt=<? echo $dateSelection; //21-03-2019?>&flg=tb_2">Carian Mengikut Tarikh</a></li>
		<?}?>
...
$tarikh= DateTime::createFromFormat('Y-m-d H:i:s', $tarikh)->format('d/m/Y g:i a');
									...
									<A HREF='../extension/html2pdf/cetakP006_Resit.php?idt=<?=$info['id_transaksi'];?>' target='_blank' class="btn btn-default"><IMG SRC='imgs/print.gif' WIDTH='16' HEIGHT='16' BORDER='0' ALT='cetak' TITLE='Cetak'>Cetak Resit</A>
