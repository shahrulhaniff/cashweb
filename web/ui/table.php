                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:200px;">Kod PTj</th>
									...
									<?php 
									$data3 = mysql_query("SELECT * FROM kod_jabatan") 
									 or die(mysql_error()); 
...
$data = mysql_query("SELECT * FROM kod_jenistransaksi GROUP BY jabatan");
$i=1;
...
echo "<td>".$jaba."</td>";/* ?><td><?=$info['jabatan']?></td><? */ //column dua
...
<!--								
												...
												<label>Jenis Transaksi</label>
												<?php 
												$dataJenistransaksi = mysql_query("SELECT DISTINCT(jenistransaksi)AS jenistransaksi FROM kod_jenistransaksi WHERE jenistransaksi != '".$fetchK['jenistransaksi']."'");
											?>
											<select required class="form-control" name="jenistransaksi" value="">
...
<?php
$data3 = mysql_query("SELECT * FROM kod_jabatan") or die(mysql_error()); 
 while($row3 = mysql_fetch_array( $data3 )) {
	echo "<option value='".$row3['idptj']."'>".$row3['namaptj']."</option>";
}//mysql_free_result($row3);
?>
</select>
											</div>
