				...
				<form action="../web/controller/change_password_process.php" method="POST">
						<table align="center" width="500px" cellspacing="10px">
							<tr>
								...
								<td width="350px"><input type="password_lama" name="currentPswrd" size="40" class="form-control" placeholder="Masukkan Kata Laluan Semasa" required></td 
							</tr>
							<tr>
								<td width="150px">Kata Laluan Baru :</td>
								<td width="350px"><input type="password_baru" name="newPswrd" size="40" class="form-control" placeholder="Masukkan Kata Laluan Baru" required></td>
							</tr>
							<tr>
							<td colspan="2"><br>
